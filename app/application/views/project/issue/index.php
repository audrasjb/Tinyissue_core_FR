...
<div class="pad">
		...
		<li>
			<div class="insides">
				<div class="topbar">
					...
					a ouvert ce ticket le <?php echo date('d/m/Y à G\hi', strtotime($issue->created_at)); ?>
				</div>
	...
	<div class="new-comment" id="new-comment">
		...
		<form method="post" action="">
			...
			<p style="margin-top: 10px;">
				<input type="submit" class="button primary" value="Publier ce commentaire" />
			</p>
	...
	<?php else: ?>
	<p>
	<?php echo HTML::link(Project\Issue::current()->to('status?status=1'), '> Réouvrir ce ticket'); ?>
	</p>
	<?php endif; ?>
</div>
